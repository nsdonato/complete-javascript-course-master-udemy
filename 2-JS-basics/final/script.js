...
/*****************************
* 17. The Ternary Operator and Switch Statements
*/
/*
var firstName = 'John';
var age = 14;
...
GOOD LUCK 😀
*/
/*----------------------------------------- Mi solución (el de el es mejor, pero no esta tan mal este. Aparte el de el, par ami las cuentas no estan bin..)
...
var JohnBills = {
    ...
    calculateTip: function (bills) {
        ...
        for (i = 0; i < bills.length; i++){
            ...
            this.finalPaidment[i] = bills[i] + this.tips[i];
        }
    }
}
...
JohnBills.calculateTip(JohnBills.values);
MarkBills.calculateTip(MarkBills.values);

console.log(JohnBills, MarkBills);
console.log('Average Tips from Marks: ' + averageTips(MarkBills.tips));
console.log('Average Tips from Johns: ' + averageTips(JohnBills.tips));
console.log(averageTips(MarkBills.tips) > averageTips(JohnBills.tips) ? 'Marks its highest tips: ' + averageTips(MarkBills.tips) : 'John its highest tips: ' + averageTips(JohnBills.tips));
--------------------------------------------- Fin*/
